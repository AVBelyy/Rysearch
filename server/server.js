...
if (process.argv.length > 2) {
    sockHost = process.argv[2];
} else {
    sockHost = "localhost:2411";
}
sock.connect("tcp://" + sockHost);
...
var server = app.listen(3000, function () {
    ...
    console.log("Rysearch-front listening at http://%s:%s", host, port);
});
